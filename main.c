...
//TODO input delle subnet e degli host delle subnet
void check_input(char *network_address, char *cidr_address, char *subnet_mask)
{
	...
	if(!check_ip_address(network_address) || !check_cidr_address(cidr_address))
		check_input(network_address, cidr_address, subnet_mask);
...
int main()
{
	...
	check_input(network_address.address, network_address.cidr_address, network_address.subnet_mask);
	return 0;
}
